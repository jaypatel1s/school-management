export function TeacherAssignmentSubmissions({ assignmentId }: { assignmentId: string }) {
  ...
  const submissions = [
    {
      ...
      status: 'Submitted',
      grade: 'A',
      file_url: '/assignments/file1.pdf'
    },
    {
      id: 2,
      ...
      status: 'Submitted',
      grade: 'B+',
      file_url: '/assignments/file2.pdf'
    },
    {
      id: 3,
        ...
        {submissions.map((submission) => (
          <div key={submission.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <div className="text-right">
              ...
              {submission.file_url && (
                <button className="text-xs text-blue-600 hover:text-blue-800 mt-1 block">
                  Download File
                </button>
              )}
            </div>
