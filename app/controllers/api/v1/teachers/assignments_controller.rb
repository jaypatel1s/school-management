  ...
  module V1
    module Teachers
      class AssignmentsController < BaseController
        ...
        def index
          assignments = current_user.teacher.assignments.includes(:course, :submissions).where(@conditions)
        ...
        def create
          @assignment = current_user.teacher.assignments.new(assignment_params)
        ...
        def set_assignment
          @assignment = current_user.teacher.assignments.find(params[:id])
